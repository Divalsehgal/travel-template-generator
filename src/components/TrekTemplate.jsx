export default function TrekTemplate({ content }) {
  return (
    <div className="a4-container bg-white mx-auto p-6 print:p-8 text-[#1b3022] shadow-xl print:shadow-none relative overflow-hidden">
      ...
      <section className="mb-3">
        <div className="relative h-20 print:h-40 rounded-lg overflow-hidden mb-2 shadow-lg print:shadow-xl border-2 border-forest-green/10">
